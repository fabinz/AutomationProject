...
public class FlightBookingDTO {
	...
	public String toString() {
		return "FlightBookingDTO [fname=" + fname + ", lname=" + lname + ", meal=" + meal + ", ccard=" + ccard
				+ ", number=" + number + ", edate=" + edate + ", eyear=" + eyear + ", frstname=" + frstname
				+ ", midname=" + midname + ", lastname=" + lastname + ", billadd=" + billadd + ", city=" + city
				+ ", state=" + state + ", postalcode=" + postalcode + ", country=" + country + ", deladd=" + deladd
				+ ", delcity=" + delcity + ", delstate=" + delstate + ", delpost=" + delpost + ", delcountry="
				+ delcountry + "]";
	}
